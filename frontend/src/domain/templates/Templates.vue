...
<template>
  <div class="flex p-2 bg-white">
    <div class="w-full">
      <div class="flex justify-between">
        <span>
          <i
            class="cursor-pointer bg-primary-10 text-primary rounded p-2 fa-solid fa-refresh my-auto"
            @click="fetch"
          ></i>
        </span>
  ...
  <AppModal v-model="templatePreview" xl2>
      ...
      {{ selectedTemplate?.templateName || "Loading..." }}
    </h2>
      ...
      <div class="w-full">
        <div class="flex">
          <span class="mx-auto text-center justify-center">
            <i
              class="mx-auto fa-solid fa-exclamation-circle text-3xl text-warning-600"
            ></i>
          </span>
        </div>
        <p class="py-5">
