...
<template>
    <div class="p-0">
        <div class="mb-2 bg-white font-semibold text-gray-500 rounded-md max-w-[350px] mx-auto border border-black-600">
            <div class="text-semibold text-black-900 text-xs text-center pt-1">CHOOSE DATES TO VIEW REPORT.</div>
