...
<template>
    <div class="p-0">
        <div class="mb-3 bg-white font-semibold text-gray-600 rounded-md max-w-[350px] p-1 pl-4 text-sm mx-auto">
            <div class="text-semibold text-black text-sm text-center">CHOOSE DATES TO VIEW REPORT.</div>
            <div class="flex">
